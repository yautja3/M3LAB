...
def main():
    ...
    while(answer != 8):
        ...
        print("7. Take payment from customer.")
        print("8. Exit")
...
def printInvoice(customers, movies):
    ...
    for customer in customers:
        if(custFname == customer.firstName) and (custLname == customer.lastName):
            for movie in movies:
                #print(customer.custID, "  ", movie.rentedBy)
    ...
    if(totalFees == 0):
        ...
        print(customer.firstName, customer.lastName, "owes", totalFees, "in late fees.")
